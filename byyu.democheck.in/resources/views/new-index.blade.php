...
<body>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="logo mt-1 mb-1">
                <a href="{{url('/')}}"><img src="https://byyu.b-cdn.net/images/other_images/BYYU_Logo.png" class="img-fluid"></a>
              </div>
              ...
              <div class="top_othermenu_box">
                   <a href="{{url('wishlist')}}" class="top_cart_box">
                    <div class="top_othermenu_imgbox"><img src="{{ENV('APP_URL')}}assets/images/top_wishlist_icon.png" class="img-fluid">
                        @if(!empty($summary['wishlist_count']))
                          <div><span>{{$summary['wishlist_count']}}</span></div>
                        @endif
                    </div>
                    <div class="top_othermenu_heading">Wishlist</div>
                  </a>
                  <a href="{{url('cart-summary')}}" class="top_cart_box">
                    <div class="top_othermenu_imgbox"><img src="assets/images/top_cart_icon.png" class="img-fluid">
                      @if(!empty($summary['cart_count']))
                      <div><span>{{$summary['cart_count']}}</span></div>
                      @endif
                    </div>
    ...
    <div class="middle_box width100">
        ...
        <section class="home_banner_mainbox">
            ...
            <div id="banner_show" class="home_banner_mainbox need_showbox">
        ...
        <section class="mb-5 need_hidebox home_categories_box">
            <img src="{{ENV('APP_URL')}}assets/images/categories_content_img.jpg" class="img-fluid">            
        </section>
