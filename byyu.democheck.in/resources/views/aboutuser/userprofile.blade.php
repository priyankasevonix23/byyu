        ...
        <div class="container" style="position: relative; z-index: 5;">
            <div class="row">
                ...
                <div class="col-lg-8 mt-5">
                    <div class="row">
                        <div class="col-lg-12 black_heading mb-4 pb-2" style="border-bottom: 1px dashed #000;">
                            My Profile <br>
                        ...
                        <form method="POST" id="deleteAccountForm" action="{{route('deleteaccount')}}">
                            @csrf
                            <div class="col-lg-9 alert alert-danger mb-4 d-none" id="delete-acocunt-alert">
                                Are you sure want to delete this account ? 
                                <button type="button" class="red_button btn-yes">Yes</button>
                                <button type="button" class="red_button btn-no">No</button>
                            </div>
                        </form>
                    </div>       
                    ...
                    <form  method="POST" id="loginform" action="{{route('userprofilesubmit')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 mb-5">
                                <div class="label_list2">
                                    <input type="text" class="input_text" name="email" id="email" value="{{$userdata['email']}}" readonly>
                                    <div class="label_position">Email ID</div>
                                </div>
                                <div class="updatenumber_box">
                                        <a href="{{route('updatemobilenumber',['email'])}}" class="red_button">Update Email ID</a>
                                    </div>
                            ...
                            <div class="col-lg-4 mb-5" style="position: relative;">
                                ...
                                <div class="label_list2">
                                    <input type="text" class="input_text" name="mobile" id="phone" value="{{$userdata['user_phone']}}" autocomplete="off" readonly>
                                    <input type="hidden" class="input_text" id="currentcountrycode" value="{{$data['message']}}">
                                    <?php
                                        $country_code = $userdata['country_code'];
                                        $country_code = str_replace('+', '', $country_code);
                                        ?>
                                    <input type="hidden" class="input_text" id="country_code" name="country_code" value="<?php echo $country_code; ?>">
                                    ...
                                    <div class="updatenumber_box">
                                        <a href="{{route('updatemobilenumber',['mobile'])}}" class="red_button">Update Mobile Number</a>
                                    </div>
                                    <div id="countryMessage" style="color: red; margin:10px 0 0 0; font-size: 10px; text-align:center"></div>
                            ...
                            <div class="col-lg-8 mb-2">
                                <label for="policy">
                                    ...
                                    <a href="/privacypolicy" style="color: #f03613; text-decoration: none;">I agree to the Privacy Policy<span style="color:red">*</span></a>
                            ...
                            <div class="col-lg-8 mb-3" style="position: relative;">
                                <label for="whatsapp">
                                    ...
                                    <input type="checkbox" name="whatsapp_flag" id="whatsapp_flag" checked>&nbsp;
                                    @else
                            ...
                            <div class="col-lg-12 mb-5">
                                ...
                                <input type="button" value="Delete My Account" class="red_button delete_account">
                            </div>
                        </div>
                        </div>
                    </form>
...
<script>
    $(document).ready(function() {
     ...
     const getCountryCodeFromDialCode = (dialCode) => {
        ...
        // alert(currentflag)
        //new code
        const countryCodeToDialCode = {};

    // Iterate over keys of dialCodeToCountryCode object
        Object.keys(dialCodeToCountryCode).forEach(dialCode => {
            if (dialCodeToCountryCode.hasOwnProperty(dialCode)) {
                countryCodeToDialCode[dialCodeToCountryCode[dialCode].toLowerCase()] = dialCode;
            }
        });

       const flagCodenew = currentflag.toLowerCase();
       const dialCodenew = countryCodeToDialCode[flagCodenew];
       $('#country_code').val(dialCodenew);
        ...
        if (currentflag.toLowerCase() !== "ae") {
            ...
            $('#countryMessage').text("You will receive further communication via sms");
    ...
    const isValidEmail = (email) => {
        ...
        $('.delete_account').on('click',function(){
            ...
            $('#delete-acocunt-alert').removeClass('d-none');
        });
        ...
        $('.btn-no').on('click',function(){
            $('#delete-acocunt-alert').addClass('d-none');
        });
