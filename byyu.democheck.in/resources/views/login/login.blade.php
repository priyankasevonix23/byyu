                    ...
                    <div>
                        <div class="row">
                            <div class="col-lg-12 verify_text mt-4 mb-5 text-center">
                                <h1 class="black_heading">Sign In</h1>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="login_inner2 text-center">
                                    ...
                                    @endif
                                    <form id="login-form" method="POST"action="{{route('loginsubmit')}}" enctype="multipart/form-data" style="position: relative;z-index: 50;">
                                        @csrf

                                        <fieldset class="login_number_box mb-3">
                                            <div class="mobile_number_country_box">
                                                <div id="phone-container" class="input-group">
                                                    <input type="text" class="mobile_textbox" id="phone" name="mobile" value="" formControlName="mobile">
                                                ...
                                                <div id="countryMessage" style="color: red; margin: 10px; font-size: 10px;"></div>
                                        ...
                                        @if (session()->has('alert'))
                                           <div class="alert alert-danger alert-box">
                                               {{session()->get('alert')}}
                                               <button type="button" class="red_button btn_ok">OK</button>
                                            </div>
                                        @endif
                                        <fieldset class="form-group mb-5 otp-box @if (session()->has('alert')) d-none  @endif ">
                                    ...
                                    <div class="col-lg-12">
                                        <a href="{{ route('login.google') }}">
                                            <img src="{{ asset('assets/images/login/continue_google.png') }}" style="max-height: 40px;  margin: 0 0 30px 0;">
                                        </a>
