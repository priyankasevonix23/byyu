        ...
        <section class="mb-5 product_details_mainbox">
            ...
            <div class="container">                
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 mb-2 mt-4 ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="product_img_gallerybox" style="max-width: 95%; margin: 0 auto; overflow: hidden;">
                                        <div id="sync1" class="owl-carousel_img_gallery">
                                            @if(!empty($productDetail['images']))

                                                @foreach($productDetail['images'] as $image)
                                                    <div class="item">
                                                        <!-- <img class="xzoom" id="xzoom-default"  src="{{ENV('BUNNY_NET_URL')}}{{$productDetail['images'][0]['image']}}?width=800&height=800" alt="{{$productDetail['product_name']}}" xoriginal="{{ENV('BUNNY_NET_URL')}}{{$productDetail['images'][0]['image']}}?width=800&height=800" /> -->
                                                        <img class="xzoom" id="xzoom-default"  src="{{ENV('BUNNY_NET_URL')}}{{$image['image']}}?width=800&height=800" alt="{{$productDetail['product_name']}}" xoriginal="{{ENV('BUNNY_NET_URL')}}{{$productDetail['images'][0]['image']}}?width=800&height=800" />
                                                    </div>
                                                @endforeach
                                        ...
                                        <div id="sync2" class="owl-carousel_img_gallery">
                                            @if(!empty($productDetail['images']))
                    ...
                    <div class="col-lg-7 right-section">
                        ...
                        <div class="row details_heading_desktop mb-4">
                            ...
                            <div class="col-lg-12 text_24_black" style="border-bottom: 1px solid #ccc;">
                                ...
                                <h1 class="details_heading" style="font-family: Metropolis-Bold;">{{$productDetail['product_name'] ?? ''}}</h1>
                                ...
                                <div class="details_price_box text_24_black">
                                    ...
                                    @foreach($productDetail['varients'] as $key=>$varient)
                                     ...
                                     <div class="home_product_price @if($key != 0) d-none @endif" id="home_product_price_{{$varient['varient_id']}}">
                                        ...
                                        @if($varient['discountper'] > 0)<span>{{$varient['mrp'] ?? '0'}} </span>@endif
                                             
                                        <div class="discount_text">@if($varient['discountper'] > 0){{$varient['discountper'] ?? ''}}% Off @endif
                                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="available_box" style="background-color: #fff; padding: 20px; position: relative;border: 1px solid #ccc;">

                                    <div class="row">

                                        <div class="col-lg-12 text_25_black mb-2">Select variant:</div>
                            ...
                            @endphp
                                            ...
                                            <div class="select_varient_list" data-is-favourite="{{$varient['isFavourite']}}">

                                                <input type="radio" name="varient22" class="varients_dd" value="{{$varient['varient_id']}}" id="varient{{$varient['varient_id']}}">

                                                <label for="f1">

                                                    <div class="varient_img"><img src="{{ENV('BUNNY_NET_URL')}}{{$productDetail['images'][0]['image']}}?width=800&height=800" class="img-fluid" alt=""></div>

                                                    <div class="varient_rightbox">

                                                        <div class="varient_text">{{$varient['quantity']}} {{$varient['unit']}}</div>

                                                        <div class="varient_price">AED {{$varient['price'] ?? '0'}} </div>
                        ...
                        <?php 
                         $varient=explode(',',$productDetail['varient']);
                        if(count($productDetail['flavour']) > 0 || ($productDetail['varient'] != NULL && $productDetail['varient'] != ' ') ) {  
                        ?>
                        <div class="row">
                            <div class="col-lg-12 mb-4">
                                <div class="available_box" style="background-color: #fff; padding: 20px; position: relative;border: 1px solid #ccc; float:left; width:100%">
                                    <?php if(count($varient) == 2 && ($productDetail['varient'] != NULL && $productDetail['varient'] != ' ')) {  ?>
                                    <div class="egg_box">
                                    <div class="flavour_heading">Choose Type:</div>
                                    <div style="float: left;">
                                    <input type="radio" id="withegg" value="egg" name="egg_eggless" >
                                    <label for="withegg">
                                    With Egg
                                    <img src="{{ENV('APP_URL')}}assets/images/withegg_icon.png" alt="">
                                    <span><img src="{{ENV('APP_URL')}}assets/images/egg_tick.png" alt="" class="img-fluid"></span>
                                    </label>
                                    </div>
                                    <div style="float: left;">
                                    <input type="radio" id="eggless" value="eggless" name="egg_eggless" >
                                    <label for="eggless">
                                    Eggless
                                    <img src="{{ENV('APP_URL')}}assets/images/eggless_icon.png" alt="">
                                    <span><img src="{{ENV('APP_URL')}}assets/images/egg_tick.png" alt="" class="img-fluid"></span>
                                    </label>
                                    </div>
                                    </div>
                                    ...
                                    <?php if(count($varient) == 1 && ($productDetail['varient'] != NULL && $productDetail['varient'] != ' ')) {  ?>
                                    <div class="egg_box">
                                    <div class="flavour_heading">Choose Type:</div>
                                    @if($productDetail['varient'] == 'egg')
                                    <div style="float: left;">
                                    <input type="radio" id="withegg" value="egg" name="egg_eggless" >
                                    <label for="withegg">
                                    With Egg
                                    ...
                                    @if($productDetail['varient'] == 'eggless')
                                    <div style="float: left;">
                                    <input type="radio" id="eggless" value="eggless" name="egg_eggless" >
                                    <label for="eggless">
                                    Eggless
                                    ...
                                    <?php if(count($productDetail['flavour']) > 0) {  ?>
                                    <div class="flavour_box">
                                        <div class="flavour_heading">{{$productDetail['flavour_name']}}:</div>
                                        <select name="flavour">
                                            <option>Select {{$productDetail['flavour_name']}}</option>
                                            @foreach($productDetail['flavour'] as $flavour)
                        ...
                        <input type="hidden" name="product_id" class="product_id" value="{{$productDetail['varient_id'] ?? ''}}">
                                ...
                                <div class="available_box" style="background-color: #f9f8ee; padding: 20px 30px 20px 30px; position: relative;">
                                    ...
                                    <div class="row" style="font-size: 12px;">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="details_datebox" id="timesoltDate" <?php if($productDetail['delivery'] == 1){ ?> style="display:none" <?php } else { ?> style="float:left;width: 140px;padding: 0 10px 0 10px;" <?php } ?> >

                                                <div class="col-lg-12">Delivery Date:</div>

                                                <div class="col-lg-12">
                                                    <input type="date" id="datePicker2" required value="{{$productDetail['cart_delivery_date']}}" style="font-size: 12px;height: 30px;padding: 5px 10px 6px 10px; width:100%">
                                                    <input type="hidden" id="from_date" id="from_date" value="{{$productDetail['from_date']}}">
                                                    <input type="hidden" id="to_date" id="to_date" value="{{$productDetail['to_date']}}">
                                                    </div>
                                            ...
                                            <div class="details_datebox" id="timesoltother" <?php if($productDetail['delivery'] == 1){ ?> style="display:none" <?php } else { ?> style="float:left;width: 140px;" <?php } ?>>

                                                <div class="col-lg-12">Time Slot:</div>                                                

                                                <div class="col-lg-12">

                                                    <select name="timeslot" style="min-height: 37px;" class="ptimeslot" required oninvalid="this.setCustomValidity('Please select Timeslot')" oninput="setCustomValidity('')" data-time-slot="{{$productDetail['cart_delivery_time']}}"></select>
                                            ...
                                            <div id="timesoltexpressday" <?php if($productDetail['delivery'] != 1){ ?> style="display:none" <?php } ?>>{{$show_message}}</div>
                                            <div id="timesoltsameday" style="display:none;">Please order before 4:00 PM for same day delivery</div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-4">
                                <div class="available_box" style="background-color: #f9f8ee; padding: 20px 30px 20px 30px; position: relative;">
                                    <div class="row">
                                        <div class="col-lg-12 text_25_black mb-2">Personalized:</div>
                                    </div>
                                    <div class="row">
                                        @foreach($product['other_details'] as $cdetail)
                                        @if($cdetail['field_type'] == "Image")
                                        <div class="col-lg-6">
                                            <div style="padding: 10px 15px 6px 15px;float: left;width: 100%;border-radius: 10px;border: 1px solid #d5d4c8; margin:0 0 10px 0">
                                                <div style="font-size: 12px;padding: 0 0 3px 0px;font-family: Metropolis-Bold;">{{$cdetail['field_value']}}:</div>
                                                <input type="file" name="image[]" style="max-width: 100%; float:left" multiple><br>
                                                <input type="hidden"  name="imagename[]" value="{{$cdetail['field_value']}}">
                                                <span style="clear: both;float: left;font-size: 12px;padding: 5px 0 0 10px;">(Maximum File Size {{$cdetail['character_limt']}} )</span>
                                            </div>
                                        </div>
                                        @endif
                                        ...
                                        <div class="col-lg-6">
                                            <div style="padding: 10px 15px 6px 15px;float: left;width: 100%;border-radius: 10px;border: 1px solid #d5d4c8; margin:0 0 10px 0">
                                                <div style="font-size: 12px;padding: 0 0 3px 0px;font-family: Metropolis-Bold;">{{$cdetail['field_value']}}:</div>
                                                <textarea  name="message[]" max="{{$cdetail['character_limt']}}" cols="35" style="width: 100%;"></textarea>
                                                 <input type="hidden"  name="textname[]" value="{{$cdetail['field_value']}}">
                                                <span style="clear: both;float: left;font-size: 12px;padding: 5px 0 0 10px;">(Maximum Character Limit {{$cdetail['character_limt']}} )</span>
                                            </div>
                                        </div>
                                        @endif
                                        @endforeach 
                        ...
                        <!--                                <div class="col-lg-12 text_25_black mb-2">{{$cdetail['field_value']}}:</div>-->
                        ...
                        <!--                                    <input type="file" name="image" style="max-width: 300px; float:left">-->

                        <!--                                    <input type="button" class="related_pro_viewbox" name="Upload">-->

                        <!--                                    <div style="font-size: 13px;margin: 10px 0 0 10px;float: left;">(Maximum File Size {{$cdetail['character_limt']}}  MB )</div>-->
                        ...
                        <!--                                        <div style="font-size: 13px;margin: 0px 0 0 10px;float: right;">(Maximum Character Limit {{$cdetail['character_limt']}})</div>-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-4 mt-4">
                                ...
                                <div class="" style="float: left;width: 100%;overflow-y: auto; overflow-x:auto; padding: 0 20px 20px 0;max-height: 250px;scrollbar-color: #b8b8b8 #efefef;scrollbar-width: thin;">{!! $productDetail['description'] ?? '' !!}</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 text_25_black pb-2 mt-5">
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
        ...
        $('.select_varient_list').on('click',function(){
            ...
            $('.product_wishlist').attr('data-product-id',$(this).find('input:radio').val());

            if($(this).data('is-favourite') == true){
                var iconurl = "{{ENV('APP_URL')}}"+'assets/images/product_wishlist_active.png';
                $('.product_wishlist img').attr('src',iconurl);
            }else{
                var iconurl = "{{ENV('APP_URL')}}"+'assets/images/product_wishlist.png';
                $('.product_wishlist img').attr('src',iconurl);
            }
        ...
        if(dtype == 1 ){
            ...
            if(dtype == 3 ){
               ...
               // $('.ptimeslot').atrr('disabled',false);
                ...
                $('#datePicker2').attr('min', from_date);
                $('#datePicker2').attr('max', to_date);
                }else
                {
                 $('#datePicker2').attr('min', maxDate);   
                }
