            ...
            <div class="container-fluid" style="position: relative;">
                ...
                <div>                    
                    ...
                    <div class="about_listing_rightbox">
                                    ...
                                    <div class="container" style="position: relative;z-index: 5;">
                                        <div class="row">
                                            <div class="col-lg-12 mt-3 mb-2 text-center">
                                                <h1 class="black_heading" style="font-size: 25px">{{ucfirst($eventDetails['event_name'] ?? '')}}</h1>
                                                @php  
                        ...
                        <div id="productData">
                                @include('includes.filtered-product-list', ['categoryProducts' => $eventProducts])
                        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('.cattitle').on('change',function(){
            ...
            form.ajaxSubmit({
                  target: target,
                  data: { pricesortid: $('#pricesortid:selected').val(),discountsortid: $('#discountsortid:selected').val(),sortid: $('#sortid:selected').val()}
            });
        });
